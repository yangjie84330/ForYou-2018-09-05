        ...
        $(function(){
            ...
            function append_li()
            {
                ...
                for (var i=0; i <= total-1; i++){
                    if(i == (ac)/2){
                        li += "<li data-target='#mycarousel' data-slide-to='"+i+"' class=' carousel slide carousel-fade active'></li>";					
                    }else{
                        li += "<li data-target='#mycarousel' data-slide-to='"+i+"' class='carousel slide carousel-fade '></li>";						
                        }
                    }
